...
Đề bài:
    ...
    Ví dụ:
        ...
        - Trong 100 thẻ có bao nhiêu % là thẻ của hợp đồng là signed, bao nhiều % của hợp đồng block,...
        - trong 100 giao dịch có bao nhiêu % là giao dịch của hợp đồng là signed, bao nhiều % của hợp đồng block,...
